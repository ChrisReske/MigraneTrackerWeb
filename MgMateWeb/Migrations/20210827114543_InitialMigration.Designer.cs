...
namespace MgMateWeb.Migrations
{
    ...
    [Migration("20210827114543_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MgMateWeb.Models.EntryModels.Entry", b =>
                {
                    ...
                    b.Property<int?>("PainIntensityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MgMateWeb.Models.EntryModels.PainIntensity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MgMateWeb.Models.EntryModels.Entry", b =>
                {
                    b.HasOne("MgMateWeb.Models.EntryModels.PainIntensity", "PainIntensity")
                        .WithMany()
                        .HasForeignKey("PainIntensityId");

                    b.HasOne("MgMateWeb.Models.EntryModels.WeatherData", "WeatherData")
                        .WithMany()
                        .HasForeignKey("WeatherDataId");

                    b.Navigation("PainIntensity");
